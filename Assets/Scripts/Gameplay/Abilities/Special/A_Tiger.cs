...
namespace Geneforge.Gameplay.Abilities.Special
{
    ...
    public class A_TigerRend : EssenceAbility
    {
        ...
        class RendStacksStatus : MonoBehaviour
        {
            ...
            public void Setup(A_TigerRend ability, EnemyCore e)
            {
                def = ability; enemy = e;
                if (!hud)
                {
        ...
        class TigerStackHUD : MonoBehaviour
        {
            ...
            public void UpdateHUD(int stacks, int maxStacks, EnemyCore enemy)
            {
            ...
            public void TickAnchor(EnemyCore enemy)
            {
            ...
            float EstimateHeight(EnemyCore enemy)
            {
                float h = 1.6f;
