...
namespace Geneforge.Gameplay.Characters.Enemies
{
    public class Suporte : MonoBehaviour
    {
        ...
        [Header("Behavior")]
        public bool stayStationary = true;   // Suporte fica parado por omissão
        ...
        void Update()
        {
            ...
            // Animate (mantém "Speed" a 0 se stayStationary = true; logo só Idle/Attacks)
            ...
            // 7) Wander logic (fica inativo quando stayStationary = true)
